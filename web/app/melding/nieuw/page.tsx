    ...
    <main className="min-h-screen bg-slate-50">
      <header className="bg-white border-b border-slate-100 sticky top-0 z-10">
        <div className="max-w-xl mx-auto px-6 py-4 flex items-center gap-3">
          ...
          <span className="font-semibold text-slate-900 text-sm">Nieuwe melding</span>
        </div>
      </header>

      <div className="max-w-xl mx-auto px-6 py-8">
        <div className="mb-7">
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Nieuwe melding</h1>
          <p className="text-slate-400 text-sm mt-1">Vul het formulier in en wij bezorgen het aan de juiste gemeente.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-100 shadow-sm divide-y divide-slate-100">
          <div className="p-6 flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                required
                className="w-full border border-slate-200 rounded-lg px-3.5 py-2.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white transition appearance-none cursor-pointer"
              >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="w-full border border-slate-200 rounded-lg px-3.5 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition"
              />
              <p className="text-xs text-slate-400">{beschrijving.length} tekens</p>
            </div>
          </div>
          ...
          <div className="px-6 py-5 bg-slate-50 rounded-b-2xl flex items-center justify-between gap-4">
            <p className="text-xs text-slate-400">
              <span className="text-red-400">*</span> Verplicht veld
            </p>
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center gap-2 bg-blue-600 text-white py-2.5 px-6 rounded-lg font-semibold text-sm hover:bg-blue-700 active:bg-blue-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-blue-200"
            >
              {loading ? (
                <>
