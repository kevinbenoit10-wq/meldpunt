...
export default function HomeHero() {
  return (
    ...
    >
      ...
      {/* Heading */}
      <motion.h1 variants={item} className="text-4xl sm:text-5xl font-black text-white leading-[1.1] tracking-tight">
        Meld problemen.<br />
        Maak het verschil.
      </motion.h1>
      ...
      <motion.div variants={item} className="flex flex-wrap gap-3">
        <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
          <Link
            href="/melding/nieuw"
            className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-400 text-white px-6 py-3 rounded-lg font-semibold text-sm transition-colors"
          >
